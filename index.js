...
async function startXlesyBot() {
	...
	if (pairingCode && !Xlesy.authState.creds.registered) {
		...
		async function getPhoneNumber() {
			phoneNumber = global.number_bot ? global.number_bot : await question(`\x1b[94m
╔══════════════════════════════════╗
║  \x1b[1;35m🌟 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙇𝙓𝙇𝙀𝙎𝙔 🌟 \x1b[94m ║
║  \x1b[1;33m👑 𝘾𝙍𝙀𝘼𝙏𝙊𝙍: 𝙂𝙓𝙔𝙀𝙉𝙉 👑 \x1b[94m  ║
╠══════════════════════════════════╣
║  🚀 𝙁𝙖𝙨𝙩 & 𝙎𝙚𝙘𝙪𝙧𝙚 𝙎𝙚𝙧𝙫𝙞𝙘𝙚  🚀   ║
║  🔥 𝙃𝙞𝙜𝙝 𝙌𝙪𝙖𝙡𝙞𝙩𝙮 𝙎𝙪𝙥𝙥𝙤𝙧𝙩 🔥   ║
║  🛡️ 𝘼𝙙𝙫𝙖𝙣𝙘𝙚𝙙 𝙎𝙮𝙨𝙩𝙚𝙢 🛡️    ║
╚══════════════════════════════════╝
\x1b[0m
\x1b[1;31mPlease type your WhatsApp number : \x1b[0m`);
...
\x1b[1;32m
  ...
  Creator: Gxyenn
\x1b[1;34m══════════════════════════\x1b[0m
\x1b[1;31mConnected to: \x1b[0m` + JSON.stringify(Xlesy.user, null, 2));
